...
public class Product implements Serializable {
    ...
    public Product(String name, String description, BigDecimal price, Integer quantity, String category, Long userId) {
        this(name, description, price, quantity, category);
        this.userId = userId;
    }
